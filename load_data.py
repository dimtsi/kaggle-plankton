...
for x in range(len(train_images)):
    if train_labels[x] == 0 or train_labels[x] == 1 or train_labels[x] == 43:
        continue
    else:
        classified_train_images.append(train_images[x])
        classified_train_labels.append(train_labels[x])

pickle.dump( classified_train_images, open("pkl/extraclassified_train_images.pkl", "wb" ))
pickle.dump( classified_train_labels, open("pkl/extraclassified_train_labels.pkl", "wb"))
