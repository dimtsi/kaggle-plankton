...
from NNs import densenet161, densenet169, densenet121, densenet201, resnet50
...
if __name__ == "__main__":
    ...
    predict_test_set_kaggle(best_model, test_filenames, mean_norm_test, std_norm_test)
